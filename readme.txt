...
= Version 1.7.6 =
* Fix : issue fixed multiple mails in To field
* Fix : bug fixes

= Version 1.7.5 =
* Fix : Plain html in body issue resolved
* Fix : bug fixes

= Version 1.7.4 =
* Fix : Warnings and bug fixes
* New : Sent email user list format

= Version 1.7.3 =
* Fix : Sent mail issue fixes
...
= Version 1.6.9 =
* Fix : Fixed compatibility of PHPMailer with WordPress 5.5 
* Fix : [Support issue] = Send mail to users with a specific roll
* Fix : [Support issue] = Error after send a mail
* Fix : [Support issue] = Error in line 961 of wp-send-mail.php
* Fix : Fixed template edit issue.
* Fix : Fixed editor conflict issue.
* Fix : Fixed image and links relative path issue.
